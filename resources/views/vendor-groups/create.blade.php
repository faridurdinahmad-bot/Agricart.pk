        ...
        <div class="backdrop-blur-xl glass-panel border border-white/25 rounded-2xl p-6">
            ...
            <form method="POST" action="{{ route('vendor-groups.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="supplier_type" value="{{ old('supplier_type') }}" placeholder="e.g. Seeds, Fertilizers, Equipment" class="w-full px-4 py-2.5 rounded-xl bg-white/10 border border-white/20 text-white">
                </div>
