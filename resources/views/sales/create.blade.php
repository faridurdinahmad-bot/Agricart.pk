...
<div class="page-container">
    <div class="max-w-4xl mx-auto">
        <x-page-back :href="route('sales.index')" :title="__('app.sale.new_sale')" />
        ...
        <x-card>
            ...
            <form method="POST" action="{{ route('sales.store') }}" x-data="{ items: [{ product_id: '', quantity: 1, rate: 0 }] }">
                ...
                <div class="mb-6">
                    <x-input type="date" name="due_date" :label="__('app.sale.due_date')" :value="old('due_date')" />
                </div>
                <div class="mb-6">
                    <x-input type="textarea" name="notes" :label="__('app.sale.notes')" :rows="2">{{ old('notes') }}</x-input>
                </div>
                ...
                <div class="flex flex-wrap gap-3 pt-2">
                    ...
                    <x-button :href="route('sales.index')" variant="secondary">{{ __('app.sale.cancel') }}</x-button>
                </div>
            </form>
        </x-card>
    </div>
